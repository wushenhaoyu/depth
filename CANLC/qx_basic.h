...
class qx_timer{public: void start(); double stop(); void time_display(char *disp="",int nr_frame=1); void fps_display(char *disp="",int nr_frame=1); private: double m_pc_frequency; int64_t m_counter_start;};//clock_t m_begin,m_end;};
